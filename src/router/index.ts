...
import CustomGameSample from '@/pages/sample/custom-game.vue';
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/sample/custom-game', component: CustomGameSample },
    {
      path: '/login',
      component: Login,
    },
    ...
    //Clan router
    {
      ...
      children: [
        ...
        {
          path: CLAN_PATH.ACCOUNT_VIEW(':name', ':id'),
          component: AccountView,
...

    {
      ...
      children: [
        { path: '/home', component: Home },
        { path: '', component: ClanExplore },
        { path: 'explore/:id', component: ClanExplore },
